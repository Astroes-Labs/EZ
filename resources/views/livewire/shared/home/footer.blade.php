        ...
        <div class="max-w-screen-2xl mx-auto px-6 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-10 mb-20">
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-gray-200">
                        <li>
                            <a href="mailto:{{ config('app.support_email') }}" class="hover:text-white transition-colors">
                ...
                <div>
                    ...
                    <div class="mt-10">
                        ...
                        <div class="flex gap-6 text-2xl text-gray-300">
                            <a href="#" class="hover:text-[#eac46e] transition-colors">
            ...
            <!-- Bottom -->
            <div class="pt-10 border-t border-[#222f53]/50 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
                <p>
                    &copy; {{ date('Y') }} {{ config('app.name') }}. Built for secure digital investing.
                </p>

                <div class="flex flex-wrap gap-8 mt-6 md:mt-0">
