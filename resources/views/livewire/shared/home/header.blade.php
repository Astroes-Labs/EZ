<header class="bg-[#111827] border-b border-[#222f53] backdrop-blur-xl fixed w-full top-0 z-50" wire:ignore.self>
                ...
                <div class="relative group">
                    <button class="flex items-center gap-1 hover:text-[#eac46e] transition-colors">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="w-4 h-4 transition-transform group-hover:rotate-180" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div
                        class="absolute hidden group-hover:block pt-3 w-56 bg-[#1a2238] border border-[#222f53] rounded-2xl shadow-2xl py-2 z-50">
                        <a href="{{ route('about') }}" wire:navigate
                            class="block px-6 py-3 hover:bg-[#222f53] hover:text-[#eac46e]">Company Overview</a>
                        <a href="{{ route('testimonials') }}" wire:navigate
                            class="block px-6 py-3 hover:bg-[#222f53] hover:text-[#eac46e]">User Feedback</a>
                        <a href="{{ route('faq') }}" wire:navigate
                            class="block px-6 py-3 hover:bg-[#222f53] hover:text-[#eac46e]">FAQs</a>
                    </div>
                </div>
                ...
                <div class="relative group">
                    ...
                    <div
                        ...
                        <a href="{{ route('pricing') }}" wire:navigate
                            class="block px-6 py-3 hover:bg-[#222f53] hover:text-[#eac46e]">Strategy Plans</a>
                        <a href="{{ route('how') }}" wire:navigate
                            class="block px-6 py-3 hover:bg-[#222f53] hover:text-[#eac46e]">How it Works</a>
                    </div>
                </div>
                ...
                <div class="relative group">
                    ...
                    <div
                        ...
                        <a href="{{ route('terms') }}" wire:navigate
                            class="block px-6 py-3 hover:bg-[#222f53] hover:text-[#eac46e]">Terms of Use</a>
                        <a href="{{ route('privacy') }}" wire:navigate
                            class="block px-6 py-3 hover:bg-[#222f53] hover:text-[#eac46e]">Data Policy</a>
                    </div>
                </div>

                <a href="{{ route('contact') }}" wire:navigate
                    class="hover:text-[#eac46e] transition-colors">Support</a>
            </nav>
    ...
    <div x-show="mobileMenuOpen" class="lg:hidden bg-[#111827] border-t border-[#222f53] shadow-2xl" x-transition
        style="display: none;">
        <div class="px-6 py-8 space-y-8">
            ...
            <nav class="flex flex-col space-y-6 text-lg font-medium text-gray-200">
                ...
                <div class="space-y-4">
                    ...
                    <a href="{{ route('about') }}" wire:navigate class="block pl-4 hover:text-[#eac46e]">Company
                        Overview</a>
                    <a href="{{ route('testimonials') }}" wire:navigate class="block pl-4 hover:text-[#eac46e]">User
                        Feedback</a>
                ...
                <div class="space-y-4">
                    ...
                    <a href="{{ route('pricing') }}" wire:navigate class="block pl-4 hover:text-[#eac46e]">Strategy
                        Plans</a>
                ...
                <div class="space-y-4">
                    ...
                    <a href="{{ route('terms') }}" wire:navigate class="block pl-4 hover:text-[#eac46e]">Terms of
                        Use</a>
                    <a href="{{ route('privacy') }}" wire:navigate class="block pl-4 hover:text-[#eac46e]">Data
                        Policy</a>
                </div>
