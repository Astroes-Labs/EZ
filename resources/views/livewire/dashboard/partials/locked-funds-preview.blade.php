            ...
            <div class="site-card-body">
                <div class="row">
                    <div class="col-12 text-lg-left">
                        ...
                        <h4 class="box-title"><b>How does it work?</b></h4>
                        <p style="text-align:left;" class="text-left">
                        ...
                        <h4 class="box-title text-uppercase"><b>Benefit with time and interest rate</b></h4>
                        <p style="text-align:left;" class="text-left">
                        ...
                        <h4 class="box-title"><b>FOR MORE INFORMATION</b></h4>
                        <p style="text-align:left;" class="text-left">
                        ...
                        <h4 class="box-title"><b>WHAT DO I DO?</b></h4>
                        <p style="text-align:left;" class="text-left">
                        ...
                        <h4 class="box-title"><b>NOTE</b></h4>
                        <p style="text-align:left;" class="text-left">
