{{-- <div class="bg-[#1a2238] border border-[#222f53] rounded-3xl p-8 lg:p-12 shadow-2xl"> --}}
    ...
    <div>
                ...
                <div x-data="{ showPassword: false }">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" @click="showPassword = !showPassword"
                            class="absolute right-5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#eac46e] transition-colors">
            ...
            <div class="space-y-4 text-sm">
                <label class="flex items-center text-gray-300 cursor-pointer">
                    <input id="agree1" type="checkbox" wire:model.defer="agree1"
                        class="h-5 w-5 rounded border-[#222f53] text-[#eac46e]">
                ...
                <label class="flex items-center text-gray-300 cursor-pointer">
                    ...
                    <span class="ml-3">I agree with the <a href="{{ route('terms') }}"
                            class="text-[#eac46e] hover:underline">Terms of Service</a></span>
                </label>
                ...
                <label class="flex items-center text-gray-300 cursor-pointer">
                    ...
                    <span class="ml-3">I agree with the <a href="{{ route('policy') }}"
                            class="text-[#eac46e] hover:underline">Privacy Policy</a></span>
                </label>
            </div>
        ...
        {{-- --- IGNORE --- --}}
        <livewire:shared.register-test-filler />
    </div>