<div class="min-h-screen bg-[#07070a] text-gray-100 font-sans">
    ...
    <!-- Page Hero / Banner -->
    <section class="relative min-h-[50vh] flex items-center justify-center bg-[#07070a] overflow-hidden pt-20"
        id="banner">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
                @foreach ($dynamicPlans as $plan)
                    <div class="relative {{ $plan['border'] ? 'scale-105 z-10' : '' }}">
                        <div
                            class="pricing-card bg-[#111116] border {{ $plan['border'] ? 'border-[#8b5cf6]' : 'border-white/10' }} 
                            ...
                            @if ($plan['border'])
                                <div
                                    class="bg-[#8b5cf6] text-white text-xs font-mono font-bold tracking-widest py-1.5 text-center uppercase">
                                    MOST POPULAR
                                </div>
                            @endif
                            ...
                            <!-- Header -->
                            <div
                                class="pricing-header bg-[#111116] border-b border-white/5 py-10 text-center relative overflow-hidden">
                                ...
                                <div class="text-xs font-mono uppercase tracking-widest text-gray-500 mt-2">Weekly
                                    Return</div>
                            </div>
                            ...
                            <div class="p-8 lg:p-10 flex flex-col justify-between">
                                <div>
                                    <h3
                                        class="text-lg font-mono font-bold text-center text-white mb-8 tracking-widest group-hover:text-[#8b5cf6] transition-colors uppercase">
                                        {{ $plan['title'] }}
                                    </h3>
                                    ...
                                    <ul class="space-y-4 text-sm font-light text-gray-300">
                                        ...
                                        <li class="flex justify-between border-b border-white/5 pb-3">
                                            ...
                                            <span
                                                class="font-semibold font-mono">${{ number_format($plan['min']) }}</span>
                                        </li>
                                        <li class="flex justify-between border-b border-white/5 pb-3">
                                            <span class="text-gray-500 font-mono text-xs uppercase">Maximum</span>
                                            <span
                                                class="font-semibold font-mono">${{ number_format($plan['max']) }}</span>
                                        </li>
                                        <li class="flex justify-between pb-3">
                                            <span class="text-gray-500 font-mono text-xs uppercase">Capital
                                                Return</span>
