...
@section('content')
    <div class="max-w-7xl mx-auto">
        <div class="flex justify-between items-end mb-10">
            ...
            <div>
                <a href="{{ route('admin.settings.showcase') }}"
                    class="inline-flex items-center px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl transition font-medium shadow-sm text-sm">
                    <i class="fas fa-sliders-h mr-2"></i> Manage Homepage Showcase
                </a>
            </div>
        </div>
