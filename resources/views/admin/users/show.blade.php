        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <form action="{{ route('admin.users.impersonate', $user) }}" method="POST" class="inline">
                    @csrf
                    <button type="submit"
                        class="inline-flex items-center px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition font-medium shadow-sm">
                    ...
                    <div class="flex flex-col items-center text-center">
                        ...
                        <div class="mt-4 text-sm space-y-2">
                            <p class="flex items-center gap-2 justify-center">
                                ...
                                <span
                                    class="{{ $user->identity_verified ? 'text-green-600 font-medium' : 'text-red-600' }}">
                            ...
                            <p class="flex items-center gap-2 justify-center">
                                ...
                                <span
                                    class="{{ $user->account_verified ? 'text-green-600 font-medium' : 'text-red-600' }}">
        ...
        <div class="bg-white rounded-xl shadow-lg p-8 border-l-4 border-indigo-500">
            <div class="flex items-center justify-between mb-4">
                <div>
                    ...
                    <p class="text-sm text-gray-500">Display a custom pop-up or notification message directly on the user's
                        dashboard.</p>
                </div>
