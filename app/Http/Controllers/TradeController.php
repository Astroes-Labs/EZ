...
class TradeController extends Controller
{
    ...
    public function index()
    {
        ...
        $tradeHistory = Trade::where('user_id', Auth::id())
            ->where('status', 'CLOSED')
            ->get();
        ...
        return $this->renderDashboard('layouts.app.trade.index', [
    ...
    {
        $this->loadCharts();   // Ensure charts are loaded
